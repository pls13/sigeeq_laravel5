                ...
                <div class="panel-body">
                    ...
                    <form action="/unidades" method="POST" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="nome" id="unidade-nome" class="form-control" value="{{ old('nome') }}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="sigla" id="unidade-sigla" class="form-control" value="{{ old('sigla') }}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="rua" id="unidade-rua" class="form-control" value="{{ old('rua') }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="unidade-numero" class="col-sm-3 control-label">Número</label>
                            <div class="col-sm-6">
                                <input type="text" name="numero" id="unidade-numero" class="form-control" value="{{ old('numero') }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="unidade-bairro" class="col-sm-3 control-label">Bairro</label>
                            <div class="col-sm-6">
                                <input type="text" name="bairro" id="unidade-bairro" class="form-control" value="{{ old('bairro') }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="unidade-telefone" class="col-sm-3 control-label">Telefone</label>
                            <div class="col-sm-6">
                                <input type="text" name="telefone" id="unidade-telefone" class="form-control" value="{{ old('telefone') }}">
                            </div>
                        </div>
                        <div class="form-group">
